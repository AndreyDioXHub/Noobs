...
public class EnemyAiTutorial : MonoBehaviour
{
    ...
    private bool CheckObstacles() {
        Vector3 EyeVector = transform.position + Vector3.up * 1.75f;
        Ray ray = new Ray(EyeVector, (player.position - EyeVector));
        RaycastHit hit;
    ...
    private void AttackPlayer()
    {
        ...
        {
            ///Attack code here
            Rigidbody rb = Instantiate(projectile, transform.position + transform.up, Quaternion.identity).GetComponent<Rigidbody>();
